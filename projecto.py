...
def checkKeys(myData):
    ...
    if event.key == pygame.K_q:
        ...
        screen.blit(myFont1.render("Espera!", 1, ((0, 0, 0))), (365, 90))
        screen.blit(myFont2.render("RNA en proceso de entrenamiento..", 1, ((50, 50, 50))), (368, 150))
        screen.blit(myFont3.render("Dependiendo del tamano de data de entrenamiento puede tardar", 1, ((80, 80, 80))), (370, 190))
        pygame.display.flip()
...
def main():
    ...
    pygame.display.set_caption("Reconocimiento de escritura")
